<html lang="en">
  ...
  <?php
   ...
   if(isset($_POST['submit']) && !empty($_POST['submit'])) {
     ...
     $sql = "SELECT email FROM patient_register WHERE email = '".$email."' and approve=1";
     ...
     if($result->num_rows>0)
     {
      ...
      $_SESSION['user'] == $user;
      header('Location: http://localhost/Hospital%20Management%20System/patients/patient-dashboard.php?email='.$email.'');
     }
     else{
       $_SESSION['user'] = "";
     } 
  ...
  ?>
    ...
    <?php if(isset($_SESSION['user']) && $_SESSION['user'] == 0) { ?>              
      <div class="alert alert-danger" style="width: 940px; margin-left:200px">
         <h6><strong style="margin-left:275px">Sorry! </strong>You have not registered yet as a Patient</h6>
         <h6 style="margin-left:430px">OR</h6>
         <h6 style="margin-left:340px">Account approval is Pending!</h6>
      </div>              
     <?php } ?>
