    ...
    <div class="table-section">
        <div class="table-left">
           ...
           <div class="doctor-bar">
              <h6 class="text-light" style="margin-top: 5px; margin-left:230px">
               Delete Appointments
             </h6> 
           </div>  
             ...
             <table class="doctor-table" border="1">
              ...
              <?php 
                ...
                $sql = "SELECT p.pid , a.name, p.symptoms, p.mobile, p.address FROM appointments AS a 
