<html lang="en">
  <head>
    ...
    />
    <link rel="stylesheet" href="doctor-appointments.css" />
    <style>
      <?php include("doctor-appointments.css"); ?>
    </style>
  </head>
  <body>
    ...
    <div class="row" style="margin-top: 30px; margin-left:4px">
     <a href="http://localhost/Hospital%20Management%20System/doctors/view-appointments.php?dname=<?php echo $dname?>"
    ...
    <a href="http://localhost/Hospital%20Management%20System/doctors/delete-appointments.php?dname=<?php echo $dname?>"
       style="text-decoration: none">
      <div
        class="card"
        style="
      ...
      >
        <div  style="margin-top: 15px; margin-left:20px">
           <div style="margin-top:10px">
             <h5 class="text-light">Delete Appointment</h5>
           </div>
          <div>
            <img
              src="discharge.png"
