<html lang="en">
  <head>
    ...
    <style>
      <?php include("view-appointments.css"); ?>
    </style>
  </head>
  <body>
      ...
      <div class="table-section">
        <div class="table-left">
           ...
           <div class="patient-bar">
              <h6 class="text-light mt-1" style="margin-left: 250px">
                Appointments
             </h6> 
           </div>  
             ...
             <table class="patient-table" border="1">
              ...
              <?php 
                ...
                $sql = "SELECT a.doctor, p.firstname, p.lastname, p.symptoms FROM appointments AS a 
              ...
              <tbody>
                 <tr> 
                    <td style="font-size:13px "><?php echo $row['doctor']?></td>
    ...
    <script src="appointment-status.js"></script>
    <script
