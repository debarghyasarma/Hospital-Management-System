  ...
  <?php
   ...
   if(isset($_POST) && !empty($_POST)) {
     ...
     if($result->num_rows>0)
     {
      ...
      $_SESSION['user'] == $user;
      header('Location: http://localhost/Hospital%20Management%20System/admin/admin.php');
     }
     else{
      $_SESSION['user'] = '';
     } 
  ...
  ?>
    <div>
      ...
      >
        <div class="navbar-heading">
          ...
          href="http://localhost/Hospital%20Management%20System/homepage.html">
    ...
    <?php if(isset($_SESSION['user']) && $_SESSION['user'] == 0) { ?>              
      <div class="alert alert-danger">
         <strong style="margin-left:530px">Sorry! </strong>You are not the Admin!
      </div>              
     <?php } ?>
